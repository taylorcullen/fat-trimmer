...
const navItems = [
  { href: "/v3", label: "Dashboard", isDashboard: true },
  { href: "/log", label: "Log" },
...
export function V3Layout({ children }: { children: React.ReactNode }) {
    ...
    <div className="min-h-screen bg-[#09090b]">
      ...
      <header className="border-b border-white/5 sticky top-0 z-30 bg-[#09090b]">
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/v3" className="text-sm font-medium text-white/90">fat trimmer</Link>
